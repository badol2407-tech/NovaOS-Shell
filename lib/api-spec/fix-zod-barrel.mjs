...
const EXPLICIT_TYPES = [
  ...
  "Wallpaper",
  // Nova AI — schema components (TS types only, not Zod values)
  // Note: SendNovaMessageBody, NovaQuickAskBody, NovaQuickAskResponse are
  // body schemas exported as Zod values from ./generated/api, so they must
  // NOT be listed here — export type { } would shadow the value export.
  "NovaConversation",
...
console.log(
  "✓ api-zod barrel fixed (ListGitHubCommitsParams excluded to prevent TS2308; Nova AI types added)",
);
