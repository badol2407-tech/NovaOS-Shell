...
const DEFAULT_APPS = [
  ...
  // Phase 11 — Collaborative Cloud Development Platform
  {
    ...
    icon: "https://api.iconify.design/fluent-emoji-flat/busts-in-silhouette.svg",
    category: "Collaboration",
    description: "Create shared workspaces, invite teammates, track activity, and see who's online in real time",
  },
  {
    id: "cloud-editor",
    name: "Cloud Editor",
    ...
    category: "Developer",
    description: "Collaborative cloud code editor — edit workspace files together with syntax highlighting and live presence",
  },
] as const;
